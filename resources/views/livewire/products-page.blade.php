                            ...
                            <ul>
                                ...
                                <li class="mb-4" wire:key="{{ $category->id }}">
                                    <label for="{{ $category->slug }}" class="flex items-center dark:text-gray-400 ">
                                        <input id="{{ $category->slug }}" wire:model.live="selected_categories"
                                            type="checkbox" class="w-4 h-4 mr-2" value="{{ $category->id }}">
                            ...
                            <ul>
                                ...
                                <li class="mb-4" wire:key="{{ $brand->id }}">
                                    <label for=" {{ $brand->slug }}" class=" flex items-center dark:text-gray-300">
                                        <input id="{{ $brand->slug }}" wire:model.live="selectedBrands" type="checkbox"
                            ...
                            <ul>
                                <li class="mb-4">
                                    <label for="featured" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" id="featured" value="1" wire:model.live="featured"
                                            class="w-4 h-4 mr-2">
                                ...
                                <li class="mb-4">
                                    <label for="" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" id="onSale" value="1" wire:model.live="onSale"
                                            class="w-4 h-4 mr-2">
                        ...
                        <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                            ...
                            <div>
                                ...
                                <input type="range" wire:model.live="price_range"
                                    ...
                                    max="500000" value="100000" step="1000">
                                <div class="flex justify-between ">
                                    <span class="inline-block text-lg font-bold text-blue-400 ">{{
                                        Number::currency(1000, 'IDR') }}</span>
                                    <span class="inline-block text-lg font-bold text-blue-400 ">{{
                                        Number::currency(500000, 'IDR') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">{{
                                                Number::currency($product->price, 'IDR') }}</span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">

                                        <a href="#" wire:click.prevent='addToCart({{ $product->id }})' class=" text-gray-500 flex items-center space-x-2 dark:text-gray-400
                                            ...
                                            </svg><span wire:loading.remove>Add to Cart</span>

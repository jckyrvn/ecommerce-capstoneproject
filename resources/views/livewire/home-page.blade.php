    ...
    <section class="py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Hey There! Explore our wide range and find the perfect products that suit your
                    style and needs.
                </p>
            </div>
        </div>
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                ...
                @endforeach
                {{-- <a href="#" wire:key="brand-{{ $brand->id }}">
                    <img src="{{ url('storage/' . $brand->image) }}" alt="{{ $brand->name }}">
                    <p></p>w
                </a> --}}
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Discover a variety of categories to find products that match your interests and needs.
                </p>
            </div>
        </div>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                <a wire:key="{{ $category->id }}" class=" group flex flex-col bg-white border shadow-sm
                    rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none
